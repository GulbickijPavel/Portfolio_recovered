...
if(isset($_GET['sectionname']))
{
    ...
    if ($sectionname == 'home'){
       ...
       $startdescription = $_POST['startdescription'];
        ...
        if($skillKnowledgeEn == 'Main')
        {
            $cat = 1;
        }
        else if($skillKnowledgeEn == 'Secondary'){
            $cat = 2;
        }
        else{
            $cat = 3;
        ...
        $sql="UPDATE skills 
            SET skilldescription = CASE lang 
                ...
                WHEN 'ru' THEN '$infoRu' 
            END, 
           skillname = '$skillname', skillimage = '$skillimage', category = '$cat'
        ...
        $sql = "INSERT INTO skills (skillname, skillimage, skilldescription, lang, skillid, category) VALUES('$skillname','$skillimage','$infoEn', 'en', '$skillid', '$cat');";
        $sql .= "INSERT INTO skills (skillname, skillimage, skilldescription, lang, skillid, category) VALUES('$skillname','$skillimage','$infoLt', 'lt', '$skillid', '$cat');";
        $sql .= "INSERT INTO skills (skillname, skillimage, skilldescription, lang, skillid, category) VALUES('$skillname','$skillimage','$infoRu','ru', '$skillid', '$cat')";
